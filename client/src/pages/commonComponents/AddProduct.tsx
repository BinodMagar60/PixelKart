...
const productDataValidation = z.object({
    ...
    message: "Original price cannot be lower than price",
    path: ["originalPrice"],
});
...
const AddProduct = ({ setAddCardOpen, setchange }: propsType) => {
    ...
    return (
        <div>
            {
                loading ? <LoadingScreen loadingObject="addproduct"/> :
                    <>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div><input type="number" placeholder="10000" className="w-full border border-gray-300 rounded-md px-3 py-1.5" name="price" value={formData.price} onChange={handleChange} onWheel={(e) => e.currentTarget.blur()} /></div>
                                </div>
                                <div>
                                    <div className="font-semibold mb-2">Original Price (Rs)* <span className="text-xs">If there is no discount then keep it same as price</span></div>
                                    <div><input type="number" placeholder="10000" className="w-full border border-gray-300 rounded-md px-3 py-1.5" name="originalPrice" value={formData.originalPrice} onChange={handleChange} onWheel={(e) => e.currentTarget.blur()} /></div>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div>
                            ...
                            <div>
                                ...
                                <div><input type="number" placeholder="e.g., 10" className="w-full border border-gray-300 rounded-md px-3 py-1.5" name="qty" value={formData.qty} onChange={handleChange} onWheel={(e) => e.currentTarget.blur()} /></div>
                            </div>
                            <div>
                                            ...
                                            {selectedImages.map((image, index) => (
                                                <div key={index} className="relative group w-24 h-24">
                                                    ...
                                                    <button
                                                        ...
                                                        className="absolute top-0 right-0 bg-red-500 cursor-pointer bg-opacity-60 text-white text-xs px-1 rounded hover:bg-opacity-80  "
                                                    >
                                                        <X size={18} />
                                                    </button>
                                                </div>
                        ...
                        <div className="mt-8">
                            <button className={`text-white bg-black hover:bg-gray-900 text-lg px-4 py-2 w-full rounded-md cursor-pointer ${loading ? "bg-gray-800" : ""}`} disabled={loading} onClick={onSubmit}>Add Product</button>
                        </div>
                    </>
            }
        </div>
