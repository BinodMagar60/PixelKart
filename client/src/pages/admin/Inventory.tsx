import { CircleAlert, Edit, Eye, Plus, Save, Search, Trash2 } from "lucide-react"
...
const ProductDeleteCard = ({ selectedProduct, setDeleteCardOpen, setchange}:productdeletecardProps) => {
    ...
    return (
         <div className="fixed top-0 left-0 z-60 w-full h-full min-h-screen bg-[#c4c4c450] flex justify-center overflow-auto pt-30 sm:pt-50">
